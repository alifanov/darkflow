...
`area:worker` · `area:api` · `area:landing` · `area:checkout` · `area:auth` · `area:dashboard` · `area:email` · `area:checks` · `area:docs` · `area:infra`
...
gh label create "area:checks"    --color "c2e0c6" --description "Security-проверки"
