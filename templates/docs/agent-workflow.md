...
- Interviews, feedback and session recordings stay as their own documents: `insights/qualitative/YYYY-MM-DD-{topic}.md`. They are source material, not a daily observation.
