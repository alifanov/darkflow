...
> make reload           # (re)starts the worker under launchd; the webapp does NOT run under launchd
> make web              # runs the webapp interactively (required for the cmux launch buttons)
